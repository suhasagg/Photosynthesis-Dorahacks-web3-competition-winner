...
mod tests {
    ...
    fn valid_grpc_formatter() {
        let valid_uri: &[FormatterTest<Uri>] = &[
            ...
            FormatterTest {
                input: "test.com:9091",
                expected: Some(Uri::from_str("https://test.com:9091/").unwrap()),
            },
            FormatterTest {
                input: "tcp://test.com",
            ...
            FormatterTest {
                input: "tcp://test.com:9091",
                expected: Some(Uri::from_str("tcp://test.com:9091/").unwrap()),
            },
            FormatterTest {
