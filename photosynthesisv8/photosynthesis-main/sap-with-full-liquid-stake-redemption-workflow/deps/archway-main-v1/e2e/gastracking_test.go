...
func (s *E2ETestSuite) TestGasTrackingAndRewardsDistribution() {
	...
	{
		//msg := rewardsTypes.NewMsgSetContractMetadata(senderAcc.Address.String(), contractAddr.String(), &senderAcc.Address, &rewardsAcc.Address)
		msg := rewardsTypes.NewMsgSetContractMetadata(
			senderAcc.Address.String(),
			rewardsTypes.ContractMetadata{
				ContractAddress: contractAddr.String(),
				OwnerAddress:    senderAcc.Address.String(),
