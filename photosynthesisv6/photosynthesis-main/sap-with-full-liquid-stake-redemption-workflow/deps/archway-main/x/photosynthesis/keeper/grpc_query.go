...
func (qs *QueryServer) QueryCumulativeLiquidityAmount(ctx sdk.Context, epoch int64, centralliquidityAddr sdk.AccAddress) (*types.QueryCumulativeLiquidityAmountResponse, error) {
	amount, _ := qs.keeper.GetCumulativeLiquidityAmount(ctx, epoch, centralliquidityAddr)
	return &types.QueryCumulativeLiquidityAmountResponse{CumulativeLiquidityAmount: amount.Uint64()}, nil
}
