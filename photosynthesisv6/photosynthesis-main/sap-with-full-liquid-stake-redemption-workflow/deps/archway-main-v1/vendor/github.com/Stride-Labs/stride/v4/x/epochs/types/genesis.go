...
var (
	...
	DAY_EPOCH                         = "day"
	MINT_EPOCH                        = "mint"
	ARCH_CENTRAL_LIQUID_STAKE_INTERVAL_EPOCH = "arch-central-liquid-stake-interval-epoch"
	LIQUID_STAKING_DApp_Rewards_EPOCH = "liquid-staking-epoch"
	REWARDS_WITHDRAWAL_EPOCH          = "rewards_withdrawal-epoch"
	REDEMPTION_RATE_QUERY_EPOCH       = "redemption-rate-query-epoch"
)
...
func DefaultGenesis() *GenesisState {
	epochs := []EpochInfo{
		...
		{
			Identifier:              LIQUID_STAKING_DApp_Rewards_EPOCH,
			StartTime:               time.Time{},
		...
		{
			Identifier:              REWARDS_WITHDRAWAL_EPOCH,
			StartTime:               time.Time{},
		...
		{
			Identifier:              ARCH_CENTRAL_LIQUID_STAKE_INTERVAL_EPOCH,
			StartTime:               time.Time{},
			Duration:                time.Second * 56,
			CurrentEpoch:            0,
			CurrentEpochStartHeight: 0,
			CurrentEpochStartTime:   time.Time{},
			EpochCountingStarted:    false,
