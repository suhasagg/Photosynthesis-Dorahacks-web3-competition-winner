...
This is the repository for the IBC telemetry service for use in the Hermes IBC
relayer.

See the [telemetry documentation][telemetry-doc] in the Hermes guide for more
information.
