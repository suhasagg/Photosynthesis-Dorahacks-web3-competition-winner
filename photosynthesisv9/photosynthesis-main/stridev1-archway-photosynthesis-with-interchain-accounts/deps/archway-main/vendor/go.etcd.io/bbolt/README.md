...
You also get a consistent view of the database within this closure, however, no
...
Say you had a multi-tenant application where the root level bucket was the
