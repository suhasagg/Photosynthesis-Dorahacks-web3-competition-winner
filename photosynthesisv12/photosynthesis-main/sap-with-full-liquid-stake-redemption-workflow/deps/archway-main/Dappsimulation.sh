...
CONTAINER_ID="c93994976346"
PASSPHRASE="your_passphrase"

OUTPUT1=$(docker exec -it c93994976346 archwayd tx --home /home/photo/.photo wasm store /opt/testdata/cw20_base.wasm --node http://photo1:26657 --from pval1 --keyring-backend test --gas 2000000 --fees 500000uarch --gas-adjustment 1.4 --chain-id localnet -y)
...
# Instantiate
OUTPUT=$(docker exec -it $CONTAINER_ID archwayd tx --home /home/photo/.photo wasm instantiate --node http://photo1:26657 1 "{\"reward_address\": \"$REWARD_ADDRESS\", \"instantiation_request\": \"e30=\", \"gas_rebate_to_user\": false, \"collect_premium\": false, \"premium_percentage_charged\": 0, \"name\": \"aaaaa\", \"symbol\": \"TOK\", \"decimals\": 6, \"initial_balances\": [], \"mint\": {\"minter\": \"$MINTER_ADDRESS\"}}" --label test --from pval1 --keyring-backend test --chain-id localnet --fees 10000uarch --no-admin -y)
