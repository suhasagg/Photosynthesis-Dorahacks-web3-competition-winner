...
MsgFundFairburnPool allows an account to directly fund the fee collector pool.
...
MsgFundFairburnPoolResponse defines the Msg/MsgFundFairburnPool response type.
