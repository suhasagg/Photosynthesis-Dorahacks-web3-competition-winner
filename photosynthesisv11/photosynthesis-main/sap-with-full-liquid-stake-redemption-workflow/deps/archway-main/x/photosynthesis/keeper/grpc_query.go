...
func (qs *QueryServer) QueryCumulativeLiquidityAmount(ctx sdk.Context, epoch int64, centralliquidityAddr string) (*types.QueryCumulativeLiquidityAmountResponse, error) {
